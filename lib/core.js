if (typeof window.console == "undefined") {
  window.console = {};
  window.console.elem = document.createElement("div");
  setTimeout(function() {
    document.getElementsByTagName("body")[0].appendChild(window.console.elem);
  }, 1);
  window.console.log = function(text) {
    if (window.console.elem) {
      window.console.elem.innerHTML += text + "<br>";
    }
  };
}
...
// The WebSocket constructor is prefix-ed in some Mozilla-based
// re-map to local variable `WebSocket` if that is the case.
...
global.__FORCE_TRANSPORT_SOCKET__ = "flash";
...
// Channel.IS_SUPPORTED = IS_SUPPORTED;
...
function FlashSocketInterface() {
  ...
  FlashSocket.embed = function() {
    ...
    str[9 ] = '<embed src="' + path + '" quality="low" bgcolor="#ffffff"' +
              ' wmode="transparent" width="500" height="800"' +
    ...
    bridge.style.top = "0";
    bridge.style.left = "400px";
    bridge.style.width = "500px";
    bridge.style.height = "800px";
